...
namespace Test.LogicMine.Api.Data.Postgres
{
  ...
  public class PostgresMappedLayerTest : IDisposable
  {
    ...
    private class FrogLayer : PostgresMappedLayer<int, Frog>
    {
    ...
    private class FrogDescriptor : PostgresMappedObjectDescriptor<Frog>
    {
      public FrogDescriptor() : base("frog", "id", nameof(Frog.Id))
      {
      }

      public override string GetMappedColumnName(string propertyName)
      {
        if (propertyName == nameof(Frog.DateOfBirth))
